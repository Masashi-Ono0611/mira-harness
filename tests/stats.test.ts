...
import { sparkline, percentile } from "../src/commands/stats.js";

// sparkline: empty -> "", length matches input, min->lowest glyph, max->highest
{
...
// flat series (no range) must not divide-by-zero or NaN out
{
...
// percentile: ascending nearest-rank, clamped at the top
{
