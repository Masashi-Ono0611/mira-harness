/**
 * Unit tests for the catalog loader + filter — pure, no network. Run: `bun test`.
 */
...
test("valid custom catalog — defaults applied, fields preserved", () => {
